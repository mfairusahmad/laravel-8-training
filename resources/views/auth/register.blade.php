                                    ...
                                    <div class="card-body p-5">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="row gx-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="text-gray-600 small" for="firstNameExample">Full name</label>
                                                        <input class="form-control form-control-solid" type="text" placeholder="" aria-label="Full Name" aria-describedby="firstNameExample" name="name" value="{{ old('name') }}" required/>
                                                    </div>
                                            </div>
                                            <!-- Form Group (email address)-->
                                            <div class="mb-3">
                                                <label class="text-gray-600 small" for="emailExample">Email address</label>
                                                <input class="form-control form-control-solid" type="text" placeholder="" aria-label="Email Address" aria-describedby="emailExample" name="email" value="{{ old('email') }}" required/>
                                            </div>
                                            <!-- Form Row-->
                                            <div class="row gx-3">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control form-control-solid" type="password" placeholder="" aria-label="Confirm Password" aria-describedby="confirmPasswordExample" name="password_confirmation" required/>
                                                    </div>
                                                </div>
                                            </div>
